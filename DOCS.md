...
```
/data/codenvy                      // Project backups (we synchronize projects from remote workspaces into this folder)
...
/docker-compose.yml                // Docker compose orchestration script that coordinates launching internal services
