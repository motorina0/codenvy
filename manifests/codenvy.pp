...
# http proxy for codenvy workspaces
  $http_proxy_for_codenvy_workspaces = getValue("HTTP_PROXY_FOR_CODENVY_WORKSPACES","")
  $https_proxy_for_codenvy_workspaces = getValue("HTTPS_PROXY_FOR_CODENVY_WORKSPACES","")
# provide dns which proxy should not be used for.
# please leave this as it is if you don't need no_proxy configuration
  $no_proxy_for_codenvy_workspaces = getValue("NO_PROXY_FOR_CODENVY_WORKSPACES","")
